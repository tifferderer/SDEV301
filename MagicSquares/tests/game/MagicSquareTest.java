...
public class MagicSquareTest {
    ...
    public void testConstructor() {
        ...
        assertEquals("test constructor should be 0", (short)0, sq.getChoices());
    }
    ...
    public void testHasAlreadyChosen() {
        ...
        assertEquals("the choice should have not been chosen", false, ms.hasAlreadyChosen((byte)7));
        assertEquals("The choice has already been chosen", true, ms.hasAlreadyChosen((byte)5));
    }
